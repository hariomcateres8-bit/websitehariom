  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Design your dream menu online with Hariom Caterers.",
      },
    ],
  }),
      ...
      <SiteLayout>
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_35%,rgba(232,223,200,0.35)_0%,transparent_60%)]" />
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 grid lg:grid-cols-2 gap-12 items-center z-10">
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-[#EA3808]/10 border border-[#EA3808]/25 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase text-[#EA3808] shadow-sm">
              ...
              {/* Heading */}
              <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl leading-[1.08] font-bold text-stone-900 tracking-tight">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  to="/menu-planner"
                  className="group inline-flex items-center gap-2 bg-[#EA3808] hover:bg-[#C42200] text-white px-8 py-4 rounded-full font-bold shadow-lg shadow-red-500/25 hover:scale-105 transition-transform"
                >
                  Plan Your Menu
                ...
                <Link
                  to="/packages"
                  className="inline-flex items-center gap-2 bg-white/95 border border-stone-200 text-stone-800 hover:border-red-400 hover:bg-red-50/30 px-8 py-4 rounded-full font-semibold shadow-sm transition-colors"
                >
                  View Packages
                </Link>
              </div>
              ...
              {/* Features */}
              <div className="mt-12 flex flex-wrap gap-4 sm:gap-8 text-sm text-stone-700 font-semibold">
                <div className="flex items-center gap-2 bg-white/90 border border-stone-200 px-3.5 py-1.5 rounded-full shadow-sm">
            ...
            >
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
                {/* Canapes */}
                <div className="bg-white/95 border border-stone-200/80 p-2.5 rounded-2xl flex items-center gap-2 shadow-sm hover:border-red-400 transition">
                  <img
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center overflow-hidden">
          ...
          >
            ...
            <Link
              to="/about"
              className="mt-8 inline-flex items-center gap-2 text-[#EA3808] font-bold hover:gap-3 transition-all"
            >
              Read our full story
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="mt-4 text-stone-600">
                Exquisitely designed packages with endless customization.
              </p>
            </div>
              ...
              {PACKAGES.map((p, i) => (
                ...
                >
                  ...
                  <Link
                    to="/packages"
                    hash={p.id}
                    className="mt-6 block text-center bg-[#EA3808] hover:bg-[#C42200] text-white py-2.5 rounded-full text-xs font-bold transition shadow-sm"
                  >
                    View Details
                  </Link>
                </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-white/90 max-w-xl mx-auto">
                Use our menu planner to design a personalized menu,
                download a PDF, and share it via WhatsApp or email.
              </p>

              <Link
                to="/menu-planner"
                className="mt-8 inline-flex items-center gap-2 bg-white text-[#EA3808] hover:bg-stone-100 px-8 py-4 rounded-full font-bold shadow-lg hover:scale-105 transition-transform"
              >
                Start Planning
