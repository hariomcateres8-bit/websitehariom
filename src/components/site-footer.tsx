  ...
  return (
    <footer className="bg-[#1C1917] text-white mt-24 border-t-2 border-[#EA3808]/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        ...
        <div>
          <h4 className="text-lg font-bold mb-4 text-[#EA3808]">Explore Menu</h4>
          <ul className="space-y-2.5 text-sm text-stone-300 font-medium">
            <li>
              <Link to="/" className="hover:text-[#EA3808] transition">
                Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-[#EA3808] transition">
                About Us
              </Link>
            </li>
            <li>
              <Link to="/services" className="hover:text-[#EA3808] transition">
                Catering Services
              </Link>
            </li>
            <li>
              <Link to="/packages" className="hover:text-[#EA3808] transition">
                Fixed Menu Packages
              </Link>
            </li>
            <li>
              <Link to="/menu-planner" className="hover:text-[#EA3808] transition">
                Custom Menu Builder
              </Link>
            </li>
            <li>
              <Link to="/gallery" className="hover:text-[#EA3808] transition">
                Photo Gallery
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-[#EA3808] transition">
                Contact & Bookings
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h4 className="text-lg font-bold mb-4 text-[#EA3808]">Contact Us</h4>
      ...
      <div className="border-t border-stone-800 bg-black/30">
        <div className="max-w-7xl mx-auto px-4 py-5 text-xs text-stone-400 text-center flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <span className="text-[#EA3808] font-semibold">100% Pure Veg Catering Specialists</span>
        </div>
      </div>
    </footer>
  );
